...
import 'package:useva/LoginPage.dart';
import 'package:page_transition/page_transition.dart';
import 'package:useva/auth_provider.dart';
import 'package:useva/root.dart';
...
class _MainPageState extends State<MainPage> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _scale2Animation = Tween<double>(
      ...
      if (status == AnimationStatus.completed) {
        Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: rootpage()));
      }
    });
  }
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("We Hope that you'll help us to save someone's life by donating precious blood",
